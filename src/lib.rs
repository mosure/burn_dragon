...
pub mod api {
    ...
    pub use burn_dragon_kernel::api as kernel;
    pub use burn_dragon_kernel::api as wgpu;
    ...
    pub use burn_dragon_universality::api as universality;
    ...
    pub mod expert {
        ...
        pub use burn_dragon_kernel::api::expert as kernel;
        pub use burn_dragon_kernel::api::expert as wgpu;
        pub use burn_dragon_language;
        pub use burn_dragon_multimodal;
        pub use burn_dragon_stream;
        pub use burn_dragon_sudoku;
        pub use burn_dragon_universality;
...
pub use burn_dragon_kernel as kernel;
pub use burn_dragon_kernel as wgpu;
...
pub use burn_dragon_universality as universality;
