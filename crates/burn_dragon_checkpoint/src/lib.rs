...
pub mod api {
    ...
    pub mod burnpack {
        pub use crate::parts::{
            ...
            apply_burnpack_parts_bytes_with_progress, burnpack_parts_manifest_path,
            ensure_burnpack_parts, load_model_from_burnpack_part_bytes,
            load_model_from_burnpack_part_bytes_with_progress, load_model_from_burnpack_parts,
            load_model_from_burnpack_parts_with_progress, load_model_from_burnpack_file,
            load_model_from_burnpack_candidates, load_model_from_burnpack_candidates_with_progress,
            manifest_is_complete, read_parts_manifest, resolve_part_entry_path,
            save_model_to_burnpack, save_model_to_burnpack_with_parts,
    ...
    pub mod run {
        pub use crate::run::{
            ...
            resolve_checkpoint_base, resolve_checkpoint_run_dir, run_snapshot_path,
            write_json_snapshot,
        };
    }
...
pub use parts::{
    ...
    load_model_from_burnpack_part_bytes, load_model_from_burnpack_part_bytes_with_progress,
    load_model_from_burnpack_parts, load_model_from_burnpack_parts_with_progress,
    load_model_from_burnpack_file, load_model_from_burnpack_candidates,
    load_model_from_burnpack_candidates_with_progress, manifest_is_complete,
    ...
    try_load_model_from_burnpack_candidates_with_progress, try_load_model_from_burnpack_parts,
    try_load_model_from_burnpack_parts_with_progress, write_burnpack_parts,
};
pub use policy::{BurnpackLoadPolicy, BurnpackPrecisionPreference, burnpack_path, candidate_burnpack_paths};
