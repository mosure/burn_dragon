...
use burn_dragon_hatchling_core::{
    ...
    VisionAttentionMode, VisionLatentActivation, VisionMaeCrossViewConfig, VisionMaeLossConfig,
    VisionPatchEmbedMode, VisionReconLossConfig,
};
#[cfg(not(target_arch = "wasm32"))]
use burn_dragon_hatchling_core::{VisionTrainingModeConfig, load_vision_training_config};
#[cfg(not(target_arch = "wasm32"))]
use burn_dragon_hatchling_core::train::train::resolve_vision_rollout;
