...
use crate::{
    ...
    build_gaussian_pyramid, build_laplacian_pyramid, make_minimal_vision_config, map_pyramid_mode,
    map_warp_mode, radius_norm_from_sample, render_patch_f32, sigma_norm_from_settings,
};
...
fn render_patch_gpu_f32(
    ...
    output_buffer.unmap();
    let trimmed = trim_padded_rows_bytes(&data, output_size, output_size, 8, aligned_bytes_per_row);
    Some(decode_f16_rgb(
        &trimmed,
