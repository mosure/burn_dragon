//! Vision training configuration surface.
...
use crate::model::VisionTrmClsReadoutKind;
use crate::{
...
fn default_cifar_root() -> PathBuf {
    PathBuf::from("data/cifar")
}
...
pub struct VisionDatasetConfig {
    ...
    #[serde(default = "default_cifar_root")]
    pub cifar_root: PathBuf,
